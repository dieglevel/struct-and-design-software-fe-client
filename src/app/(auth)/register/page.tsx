...
const RegisterPage = () => {
    ...
    return (
        <div className="w-full h-screen flex flex-col justify-center items-center border-2 border-colorbrand-grayWhite-200 rounded-md p-5">
            ...
            <div className="w-full lg:w-1/2">
                <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <TextField
                        ...
                        className="border-2 w-full border-gray-200 rounded-md p-2"
                    />
                    ...
                    <button
                        type="submit"
                        className="bg-colorbrand-burntSienna-500 text-white rounded-md p-2 w-1/2 m-auto mt-10"
                    >
                        Đăng ký
                    </button>

                    <div className="flex flex-row justify-center gap-2 mt-5">
                        <p className="text-colorbrand-grayWhite-500 text-sm">Đã có tài khoản?</p>
